# -*- coding: utf-8 -*-
import numpy as np
from rcit.radar_data_io.nrd_pa_radar_data.PAProtocol import dtype_PA

from pycwr.io.util import _prepare_for_read, _unpack_from_buf, julian2date_SEC, make_time_unit_str
from pycwr.core.NRadar import PRD
from pycwr.configure.pyart_config import get_metadata, get_fillvalue
...
class PABaseData(object):
    ...
    def _check_standard_basedata(self):
        ...
        :return:
        """
        assert self.fid.read(12)[8:] == b'\x10\x00\x00\x00', 'file is not a stardand phase array base file!'
        self.fid.seek(0, 0)
        return
